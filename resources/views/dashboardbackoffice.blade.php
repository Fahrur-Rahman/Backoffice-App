                ...
                <li class="item">
                    <div class="product-img">
                      ...
                      <div class="product-info row">
                        <div class="col-10">
                            <a href="javascript:void(0)" class="product-title">{{$cddt->niknumber}} - {{$cddt->fullname}}</a>
                            <span class="product-description">{{$cddt->created_at}}</span>
                        </div>
                        @if($cddt->statusid == 5)
                            @if($cddt->statusclientid == 1)
                              <div style="text-align:right;">
                                  <button type="button" class="btn btn-warning btn-sm" style="border-radius:2em;">Propose</button>
                              </div>
                            @elseif($cddt->statusclientid == 2)
                              <div style="text-align:right;">
