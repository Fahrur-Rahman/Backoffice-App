...
@section('home')
<form method="POST" action="/linked">
@csrf
        ...
        <div class="card">
              ...
              <div>
                ...
                <div style="padding-top: 25px;">
                  ...
                  <input type="hidden" name="candidatelistid" value={{$candidatelist->candidatelistid}}>
                  <p class="d-flex flex-column">
        ...
        <div class="card">
          <div class="card-body">
              ...
              @foreach($candidate as $candi)
                <option value="{{$candi->candidateid}}" >{{$candi->niknumber}} - {{$candi->fullname}}</option>
              @endforeach
              </select>
              </div>
              <div style="padding-top: 25px;">
              ...
              <div style="padding-top: 25px;">
                <div class="col-12">
                  ...
                  {{-- <input type="hidden" id="custId" name="candidatelistid" value={{$candidatelist->candidatelistid}}>
                  <input type="hidden" id="custId" name="id" value={{$candi->id}}> --}}
                  </div>
                </div>
                </div>
                </div>
            ...
            jQuery('select[name="candidate"]').on('change',function(){
               ...
               if(candidate)
               {
                  jQuery.ajax({
                     ...
                     {
                        console.log(state);
                        var nik = state.niknumber;
                        var fullname = state.fullname;
                        var email = state.email;
                        var phone = state.mobilephone;
