              ...
              <div class="card-body table-responsive p-0">
                <table class="table">
                  ...
                  <tr>
                    ...
                    <td>{{$tablecandidate->mobilephone}}</td>
      ...
      <div class="modal-body">
            ...
            <form action="/editreschedule" method="POST">
                @csrf
                    ...
                    <input class="form-control" name="resi" id="resi" type="hidden"/>
                    <input class="form-control" name="reci" id="reci" type="hidden"/>
                    <input class="form-control" name="repi" id="repi" type="hidden"/>
                    <input class="form-control" name="renik" id="renik" type="hidden"/>
                    <input class="form-control" name="rename" id="rename" type="hidden"/>
                    <input class="form-control" name="reposition" value="1" id="reposition" type="hidden"/>
                    <input class="form-control" name="reemail" id="reemail" type="hidden"/>
                    <input class="form-control" name="rephone" id="rephone" type="hidden"/>
                    <div class="form-group">
...
$('#editformnewcandidate').on('show.bs.modal', function (event) {
  ...
  var nik = button.data('niknumber')
  var name = button.data('fullname')
  var email = button.data('email')
  var phone = button.data('mobilephone')
  var position = button.data('positionid')
