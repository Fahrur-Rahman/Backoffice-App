            ...
            <div class="row">
                ...
                <div class="form-group ml-auto">
                    <div class="ml-auto" style="text-align:right;">
                        <i class="ion ion-android-time" id="reschedulemodal" style="font-size:30px;" data-toggle="modal" data-tanggalre="{{$schedule->scheduledate}}" data-cli="{{$candidatelist->candidatelistid}}"
                            data-si="{{$schedule->scheduleid}}" data-target="#formreschedule"></i>
                    </div>
                </div>
            </div>
          ...
          <div class="card-body">
            <form action="/editreschedule" method="POST">
                @csrf
                    ...
                    <input name="refullname" id="refullname" type="hidden">
                    <input name="reemail" id="reemail" type="hidden">
                    <input name="rephone" id="rephone" type="hidden">
                    <input name="repositionid" id="repositionid" type="hidden">
                    <div class="form-group">
...
var fixtanggaljadi = month + "/" + date + "/" + year + " " + jam + ":" + d.getMinutes() + " " + ampm;
    ...
    modal.find('.modal-body #refullname').val(refullname)
    modal.find('.modal-body #reemail').val(reemail)
    modal.find('.modal-body #rephone').val(rephone)
    modal.find('.modal-body #repositionid').val(repositionid)
  }));
</script>
