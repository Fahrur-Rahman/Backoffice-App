...
*/
 ...
 Route::get('/adduser', function () {
     return view('/registerbackoffice');
 });

 Route::post('/addregister', 'AddregisteruserController@adduser');
...
Route::middleware('auth')->group(function () {
    ...
    */
    ...
    //Link
    Route::get('/getcandidatelist/{id}','LinkController@getcandidatelist');
    Route::post('/linked' , 'LinkController@store');
