...
class CandidateListScheduleController extends Controller
{
    ...
    public function index()
    {
        ...
        $candidatelistschedule = DB::table('backoffice.link as dt1')->join('recruitmen.candidate as dt2', 'dt2.candidateid', '=', 'dt1.candidateid')
...
// dd($candidatelistschedule);
    ...
    public function history(Request $request)
    {
        ...
        ->where('candidatelistid',$id->candidatelistid)->first();
